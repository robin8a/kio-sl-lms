...
export class AutoVideoPlayer extends Component {
    state = {
        url: null,
        pip: false,
        playing: true,
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    <th>Files</th>
                    <td>
                      {this.renderLoadButton('https://kio-sl-lms-videos.s3.amazonaws.com/WhatsApp+Video+2020-09-05+at+9.29.19+PM.mp4', 'mp4')}
